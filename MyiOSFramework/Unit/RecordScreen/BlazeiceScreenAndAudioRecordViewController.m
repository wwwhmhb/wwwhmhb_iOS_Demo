...
//    [self.view addSubview:doodleView];
    ...
    doodleView.backgroundColor = [UIColor orangeColor];
    [self.view addSubview:doodleView];
    UILabel *lable = [[UILabel alloc] init];
    lable.frame = CGRectMake(0, 0, 50, 30);
    lable.center = doodleView.center;
    lable.text = @"0";
    [doodleView addSubview:lable];
    
    button = [UIButton buttonWithType:UIButtonTypeCustom];
    [button setFrame:CGRectMake(0, 140, kMainScreenWidth, 40)];
